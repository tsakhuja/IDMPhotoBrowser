...
- (UIImage *)photoBrowser:(IDMPhotoBrowser *)photoBrowser toolBarButtonImageForPhotoAtIndex:(NSUInteger)index;
- (void)photoBrowser:(IDMPhotoBrowser *)photoBrowser toolBarButtonTappedForPhotoAtIndex:(NSUInteger)index;
@end
...
@property (nonatomic) BOOL displayToolbarButton;
